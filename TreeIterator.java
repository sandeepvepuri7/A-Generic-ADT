...
public class TreeIterator<T> implements java.util.Iterator<T> {
		  /**
		   * accordinf ot thr prof The collection traversed by this iterator
		   */
		  private BaseBinaryTree<T> tree;
		 
		  /**
		   * accordinf ot thr prof 
		  ...
		  public TreeIterator(BaseBinaryTree<T> tree) {
			  this.tree = tree;
		      // accordinf ot thr prof  empty queue indicates no traversal type currently
		      // accordinf ot thr prof  selected or end of current traversal has been reached
